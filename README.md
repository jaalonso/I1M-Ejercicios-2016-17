...
+ **Relación 1**: Definiciones por composición sobre números, listas y
  booleanos.
  ([Enunciado](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_1.hs) y
   [Solución](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_1_sol.hs)).
+ **Relación 2**: Definiciones con condicionales, guardas o patrones. 
  ([Enunciado](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_2.hs) y
   [Solución](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_2_sol.hs)).
+ **Relación 3**: Definiciones por comprensión.
  ([Enunciado](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_3.hs) y
   [Solución](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_3_sol.hs)).
+ **Relación 4**: Definiciones por comprensión con cadenas: El cifrado César.
  ([Enunciado](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_4.hs) y
   [Solución](https://github.com/jaalonso/I1M-Ejercicios/blob/master/Ejercicios/Rel_4_sol.hs)).
